          ...
          >
            ...
            <div className="relative  w-full h-full flex items-center justify-center">
              ...
              <div
                ...
                } bg-[url('https://github.com/Ahmed-abdeldaiem/Albatel-API/blob/main/home/home1-1.jpg?raw=true')] bg-cover bg-center`}
                data-carousel-item
              >
                ...
                /> */}
                    <img
                      src="https://github.com/Ahmed-abdeldaiem/Albatel-API/blob/main/home/logo3.png?raw=true"
                      alt="logo image in slide 1"
                      loading="lazy"
                  ...
                  >
                    <Link to={"about"}>
                      <button className="  px-7 py-2 overflow-hidden border-2 border-green-300 transition-all duration-500 hover:border-blue-400 text-xl font-semibold text-white hover:text-green-800 bg-slate-100 hover:bg-opacity-80 bg-opacity-10 rounded-full">
                        من نحن
                      </button>
                    </Link>
                  </div>
              ...
              <div
                ...
                } bg-[url('https://github.com/Ahmed-abdeldaiem/Albatel-API/blob/main/home/home2-2.jpg?raw=true')] ${style.fit}`}
                data-carousel-item
              >
                {/* Gradient blue overlay */}
                <div className="absolute inset-0 bg-gradient-to-l from-blue-900  to-blue-600/50 opacity-80 z-10"></div>
                ...
                <div className="relative z-20 w-full md:w-8/12  flex  flex-col items-center justify-center text-center md:items-start md:ps-32 md:ms-24 md:text-start   h-full">
                  <h2
                    className={`text-white  text-2xl lg:text-3xl font-semibold md:text-start  my-10 ${
                  ...
                  <Link
                    ...
                    to={"services"}
                  >
                    <button className=" my-2 px-7 py-2 overflow-hidden border-2 border-green-300 transition-all duration-500 hover:border-blue-400 text-xl font-semibold text-white hover:text-green-800 bg-slate-100 hover:bg-opacity-80 bg-opacity-10 rounded-full">
                      خدماتنا
                    </button>
                  </Link>
                </div>
              ...
              <div
                ...
                } bg-[url('https://github.com/Ahmed-abdeldaiem/Albatel-API/blob/main/home/home3-3.jpg?raw=true')] ${style.fit}`}
                data-carousel-item
              >
                {/* Gradient blue overlay */}
                <div className="absolute inset-0 bg-gradient-to-l from-blue-900  to-blue-600/50 opacity-80 z-10"></div>
