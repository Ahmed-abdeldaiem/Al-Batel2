...
<h2 className='text-green-600 text-2xl 4k:text-4xl my-4 font-semibold text-start'>هدفنا</h2>
<p className='text-gray-800 text-lg 4k:text-3xl my-2 font-semibold text-center lg:text-start'>نتيجة لما يشهده قطاع الأعمال من ازدهار ملحوظ بفضل رؤية 2030</p>
<p className='text-gray-800 text-lg 4k:text-3xl font-semibold text-center lg:text-start'> نسعى ونطمح أن نكون الخيار الأول للعميل عن طريق:</p>
<h3 className="text-gray-800 text-lg 4k:text-3xl  my-4">
                <span className="text-green-600 mx-3 text-center lg:text-start">
                  <i className="fa-solid fa-circle-dot"></i>
                </span>
                إمداد العميل باحتياجاته كافة
               </h3>
<h3 className="text-gray-800 text-lg 4k:text-3xl my-4 text-center lg:text-start">
...
<div className="container m-auto my-10 ">
  ...
  />
      ...
      <div className=" w-full lg:w-1/2 py-8">
        <div className="inner flex flex-col justify-center items-center lg:justify-start lg:items-start">
<h2 className='text-green-600 text-2xl 4k:text-4xl my-4 font-semibold text-start'>Our Goal</h2>
<p className='text-gray-800 text-lg 4k:text-3xl my-2 font-semibold text-center lg:text-start'>
As a result of the remarkable prosperity witnessed by the business sector thanks to Vision 2030  </p>
<p className='text-gray-800 text-lg 4k:text-3xl font-semibold text-center lg:text-start'>
