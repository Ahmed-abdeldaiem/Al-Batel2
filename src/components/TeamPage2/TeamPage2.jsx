  ...
  return (
    <>
      ...
      {dir == "rtl" ? (
        <>
          {/* header section */}
          <div className="relative flex flex-col lg:h-[620px] 3xl:h-[790px] h-[300px] md:h-[370px] justify-center items-center mt-16 py-10  bg-center bg-no-repeat bg-cover bg-[url('https://raw.githubusercontent.com/Ahmed-abdeldaiem/Albatel-API/refs/heads/main/%D9%81%D8%B1%D9%8A%D9%82%D9%86%D8%A7.jpeg')]">
        ...
        <>
          ...
          <div className="relative flex flex-col lg:h-[620px] 3xl:h-[790px] h-[300px] md:h-[370px] justify-center items-center mt-16 py-10  bg-center bg-no-repeat bg-cover bg-[url('https://raw.githubusercontent.com/Ahmed-abdeldaiem/Albatel-API/refs/heads/main/%D9%81%D8%B1%D9%8A%D9%82%D9%86%D8%A7.jpeg')]">
            ...
            >
              One Team
              <span className="text-2xl md:text-7xl font-normal">..</span>One
              Vision<span className="text-2xl md:text-7xl font-normal">..</span>
              Boundless Success
            </h3>
            <h3
              data-aos="zoom-in"
