      ...
      {dir == "rtl" ? (
        <>
          ...
          >
            ...
            {/* hexagon */}
            <div data-aos="fade-down" className="hidden lg:flex flex-wrap lg:gap-4 z-30  justify-center">
              {words.map((word, index) => {
                return (
                  <Hexagon
                    key={index}
                    
                    className="lg:w-1/12 md:w-1/6 w-1/5 lg:p-3 md:p-2 p-1 cursor-pointer text-shadow-green  "
                    style={{
                      stroke: "#3a497b",
                      strokeWidth: 10,
                      fill: "#ffffff66",
            ...
            <h2 data-aos="fade-up" className="text-white text-shadow-xl text-xl md:text-3xl lg:text-5xl text-center shadow-xl my-1 md:my-4 lg:my-8 z-30 font-bold">
              فريق عمل شركة الباتل
            </h2>

            <h3 data-aos="zoom-in"  data-aos-delay="300" className="text-white text-shadow-xl text-xl md:text-2xl lg:text-3xl text-center w-10/12 md:w-2/3 lg:w-1/2 mt-1 md:mt-2 lg:mt-6 z-30 font-semibold">
            ...
            <h3 data-aos="zoom-in"  data-aos-delay="600" className="text-white text-shadow-xl text-xl md:text-2xl lg:text-3xl text-center  w-10/12 md:w-2/3 lg:w-1/2 mb-1 lg:mb-8  lg:mt-3 z-30 font-semibold">
              <span>من الفكرة إلى النجاح</span>
              <span className="text-2xl md:text-7xl font-normal">..</span>
             <span>فريقنا في خدمتك</span>
            </h3>

            <button data-aos="fade-up" data-aos-delay="900" className="my-2 md:my-8 lg:my-12 z-30" onClick={handleScroll}>
              <h3 className="animate-pulse inline-block text-shadow-md rounded-full md:px-8 cursor-pointer mx-1 bg-blue-100 bg-opacity-50 py-2 lg:py-3 border-blue-950 border-2 text-center z-20 text-blue-950 text-sm md:text-lg font-bold">
                تعرف على فريق العمل
                <span className="mx-2">
                    ...
                    >
                      ...
                      >
                        ...
                        <div  className=" flex  p-1 flex-col overflow-hidden items-center justify-center text-center">
                          <h5  className="text-shadow-blue mb-4 text-2xl text-nowrap border-b-4 border-b-transparent  group-hover:border-blue-600 duration-700 transition-all pb-3 text-blue-900 font-bold text-center tracking-tight">
                            {teamMember?.name?.ar}
                          </h5>
                        </div>
                      </Link>
