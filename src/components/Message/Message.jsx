...
<h2 className='text-green-600 text-2xl 4k:text-4xl mb-4 font-semibold text-start'>رسالتنا</h2>
<p className='text-gray-800 text-lg 4k:text-3xl px-1  font-semibold text-center my-4 lg:text-start'>
...
<p className='text-green-600 text-2xl 4k:text-3xl font-semibold text-center'>
...
<p className='text-gray-800 text-lg 4k:text-3xl font-semibold text-center my-4 lg:text-start'>
